    ...
    <section id='four'>
      ...
      <div className='grid-container'>
        ...
        <div className='core-container'>
          <div id='inner-core-container'>
            <h1 className='mb4'>Anatomy of a Gotchi</h1>
            <p className='mb3'>
              Boo! Gotchis are pixelated, collectible ghosts living on the
              Ethereum blockchain. They possess inherent traits that influence
              their rarity, game performance, and wearables they can equip.
              Claim a Gotchi and give it a unique name. Then interact with
              others, play games, earn crypto, and level up!
            </p>
          ...
          <p id='info-text'>
            Note: when you open a portal, the Gotchi options are randomized via
            a Chainlink True Randomizer function. It is not possible to choose
            or predict which Gotchis you will get, but you will have at least 8
            options to choose from. Wearables sold separately.
