        ...
        <div className='core-container'>
          <div className='inner-core-container'>
            ...
            <p id='description-text'>
              ...
              through the Avagotchi DAO. This will be accomplished in three
              phases.
            </p>
            <div className='card-container card-container-one'>
              ...
              <div>
                ...
                <h2>Genesis</h2>
                <p>
                  The first iteration of AavegotchiDAO was launched in tandem
                  with the GHST token distribution event. GHST token holders may
                  vote to increase or decrease project development funds, and to
                  migrate to Phase 2.
                </p>
              </div>
              <img
              ...
              />
              <h1 style={{ backgroundColor: '#FFD6E4', color: '#FF00D6' }}>
                Live
              </h1>
            </div>
            <div className='card-container card-container-two'>
              ...
              <img
                ...
                id='violet-arrow-image'
              />
              <h1 style={{ backgroundColor: '#ECCDFF', color: '#9F3DDB' }}>
                Q2
              </h1>
            </div>
            <div className='card-container button-container'>
              ...
              <div>
                ...
                <p>
                  ...
                  mechanics, ecosystem spending, and even smart contract
                  upgrades will be voted on by the CHST token holders.
                </p>
              </div>
              <h1 style={{ backgroundColor: '#ECCDFF', color: '#9F3DDB' }}>
                Q4
